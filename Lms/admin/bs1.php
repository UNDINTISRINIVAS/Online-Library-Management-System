  ...
  <?php
    if(isset($_POST["submit"]))
    {
      ...
      ?>
        ...
        <input type="text" name="fullname2" placeholder="fullname" value="<?php echo($fullname) ?>" style="width:440px;height: 40px;" readonly><br>

        <input type="text" name="uname" placeholder="uname" value="<?php echo($username1) ?>" style="width:440px;height: 40px;" readonly><br>

       <!--  <input type="text" name="username2" value="<?php echo($username1) ?>" placeholder="username"  style="width:440px;height: 40px;"><br>
 -->
        <input type="text" name="email2" value="<?php echo($email) ?>" placeholder="email"  style="width:440px;height: 40px;" readonly><br>

        <input type="text" name="gender1" value="Gender: <?php echo($gender) ?>" placeholder="email" disabled style="width:440px;height: 40px;" readonly><br>

        <input type="text" name="status1" placeholder="status1" value="Status : <?php echo($status1) ?>" disabled style="width:440px;height: 40px;" readonly><br>
