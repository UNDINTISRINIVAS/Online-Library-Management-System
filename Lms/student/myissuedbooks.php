...
<?php
 $res = mysqli_query($conn,"select DISTINCT `stu_fullname`,`stu_email`,`BookName`,`BookIsbn`,`BookAuthor`,`Bpurdate` from bookissue where `stu_username`='$_SESSION[student]' and `Breturndate`='';");
